function [x_save,fc_save]=ftan(data,res,flag,xi,fci,freq_ini,varargin)
...
%         else % plotting
          ...
          %  figure(fh(i));
           ...
           % h1.Visible = 'off';
            if(opt.ABSOLUTE)
%                 xlim(h1,opt.XLIM);
                set(h1,'ylim',[min(data(i).dep),max(data(i).dep)]);
                set(h1,'SortMethod','childorder','NextPlot','replacechildren');
...
%                 fc = cal_sp.x;
            ...
            h2=axes(...
                ...
                'fontsize',opt.FONTSIZE,'fontweight',opt.FONTWEIGHT,...
                'xcolor',opt.FGCOLOR,'ycolor',opt.FGCOLOR);
            set(h2,'SortMethod','childorder','NextPlot','replacechildren');
%             xlim(h2,opt.XLIM);
            ...
            if ( flag == 0 )
                ...
                axis(h2,'tight');
            elseif ( flag == 1 )
                imagesc(T,freq_ini,x.','parent',h2,zrng);
                axis(h2,'tight');
