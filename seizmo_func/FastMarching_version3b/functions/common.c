...
int mindex3(int x, int y, int z, int sizx, int sizy) { return x+y*sizx+z*sizx*sizy; }


bool IsFinite(double x) { return (x <= doublemax  && x >= -doublemax ); }
bool IsInf(double x)    { return (x >= doublemax ); }

bool IsListInf(double x){ return (x == listINF ); }
...
int mindex2(int x, int y, int sizx) { return x+y*sizx; }
